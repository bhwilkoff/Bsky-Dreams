            ...
            VStack(spacing: 0) {
                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    VStack(spacing: 16) {
                        ...
                        // Tappable link to Bluesky's App Password settings page
                        Button {
                            if let url = URL(string: "https://bsky.app/settings/app-passwords") {
                                UIApplication.shared.open(url)
                            }
                        } label: {
                            Text("Create an App Password for Stronger Security")
                                .font(.inter(12))
        ...
        Image(systemName: "cloud.fill")
            ...
            .overlay(
                Image(systemName: "cloud")
                    ...
                    .scaledToFit()
                    .frame(width: size, height: size * 0.675)
                    // Use adaptive color: near-black in light mode, off-white in dark mode.
                    // Color.primary resolves to these values automatically.
                    .foregroundStyle(Color.primary)
                    .fontWeight(.black)
            )
    }
