...
(function () {
  ...
  const AVATAR_FALLBACK = `data:image/svg+xml,${encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40"><rect width="40" height="40" fill="#0047FF"/><circle cx="4" cy="4" r="2.5" fill="#FF5C35"/><circle cx="36" cy="4" r="2.5" fill="#B8E04A"/><circle cx="4" cy="36" r="2.5" fill="#B8E04A"/><circle cx="36" cy="36" r="2.5" fill="#FF5C35"/><line x1="0" y1="14" x2="14" y2="0" stroke="#0A0A0A" stroke-width="1" opacity="0.25"/><line x1="26" y1="40" x2="40" y2="26" stroke="#0A0A0A" stroke-width="1" opacity="0.25"/><svg x="4" y="11" width="32" height="22" viewBox="0 0 80 54"><path d="M64 44H16C11.6 44 8 40.4 8 36C8 32.1 10.9 28.9 14.7 28.3C14.6 27.7 14.5 27.1 14.5 26.4C14.5 21.8 18.3 18 22.9 18C23.9 18 24.8 18.2 25.6 18.5C28 13.4 33.1 10 39 10C46.7 10 53.1 15.7 53.7 23C54.1 22.9 54.5 22.8 55 22.8C59.3 22.8 62.8 26.3 62.8 30.6C62.8 30.8 62.8 31.1 62.7 31.3C65.9 32.3 68.5 35.5 68.5 39.5C68.5 42.1 66.4 44 64 44Z" fill="white" stroke="#0A0A0A" stroke-width="3" stroke-linejoin="round"/></svg></svg>')}`;
